...
def mix_phonemes(phn1, phn2):
  ...
  phn1_list = []
  for path, dirs, files in os.walk('strat_phoneme_set/' + phn1):
  ...
  phn2_list = []
  for path, dirs, files in os.walk('strat_phoneme_set/' + phn2):
  ...
  id1 = random.randint(0, phn_occurence[phn1])
  id2 = random.randint(0, phn_occurence[phn2])
